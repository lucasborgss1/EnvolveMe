...
import { StyledButton, StyledInput } from "../../components/utils/utils";
...
export default function PaginaInicial() {
    ...
    const handleToggleConcluido = (desafio: Desafio) => {
        ...
        const index = desafios.findIndex(d => 
            d.titulo === desafio.titulo && 
            d.area === desafio.area && 
            d.data === desafio.data
        );
    ...
    const handleAdicionarDesafio = (desafio: DesafioTemplate) => {
        ...
        const todosAdicionados = desafiosSugeridos.every(d => 
            novosDesafios.some(nd => 
                nd.titulo === d.titulo && 
                nd.data === hoje
            )
        );
                ...
                <S.LevelContent onClick={e => e.stopPropagation()}>
                    ...
                    <div>
                        {levelSystem.map((level, index) => {
                            ...
                            const xpProgress = isCompleted ? 100 : 
                                isActive ? ((currentXP - xpForThisLevel) / (xpForNextLevel - xpForThisLevel) * 100) : 0;
                            ...
                            return (
                                ...
                                >
                                    <div style={{ paddingLeft: "1rem" }}>
                                        <h5>Nível {level.level} - {level.name}</h5>
                                        <p>{level.description}</p>
                                        <div style={{ marginTop: "1rem" }}>
                                            <S.ProgressBar 
                                                progress={xpProgress}
                                                color={isActive ? "#a78bfa" : isCompleted ? "#10b981" : "#4b5563"}
                                            />
                                            <div className="level-info">
                                                <span>
                                                    {isCompleted ? "✨ Nível Completo!" : 
                                                    isActive ? `📊 ${currentXP} / ${xpForNextLevel} XP` :
                ...
                return (
                    <S.StyledDiv>
                        ...
                        <S.XPProgress onClick={() => setShowLevelModal(true)}>
                            <h4>Nível {levelInfo.level} - {levelInfo.name}</h4>
                            <S.ProgressBar 
                                progress={levelInfo.progress} 
                                color="linear-gradient(45deg, #6d28d9, #7c3aed)"
                            />
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div style={{ textAlign: "center", margin: "1rem 0" }}>
                                                <span style={{ fontSize: "2rem", color: areaColors[area.toLowerCase()] }}>
                                                    {info.concluidos}
                                                </span>
                    ...
                    <S.TituloPagina>
                                    ...
                                    borderRadius: "8px",
                                        ...
                                        {desafiosAtivos.filter(d => d.area.toLowerCase() === area).length === 0 && (
                                            <p style={{ textAlign: "center", opacity: 0.7 }}>
                                                Nenhum desafio ativo nesta área
                                            </p>
                                        )}
                                    </div>
                                </S.AreaCard>
                        ...
                        <S.TituloPagina style={{ marginTop: "3rem" }}>
                            ...
                            <p style={{ opacity: 0.8, marginBottom: "2rem" }}>
                                Use o timer para manter o foco nos seus desafios
                            </p>
                        </S.TituloPagina>
                    ...
                    <S.TituloPagina>
                        ...
                        {desafiosSugeridos.length > 0 ? (
                                ...
                                style={{
                                    ...
                                    borderRadius: "8px",
                                            ...
                                            {desafiosSugeridos.filter(d => d.area.toLowerCase() === area).length === 0 && (
                                                <p style={{ textAlign: "center", opacity: 0.7 }}>
                                                    Nenhum desafio sugerido nesta área
                                                </p>
                                            )}
                                        </div>
                                    </S.AreaCard>
                            ...
                            <div style={{
                                ...
                                <h4 style={{ marginBottom: "1rem", color: "#a78bfa" }}>
                                    Parabéns! Você já experimentou todos os desafios disponíveis! 🎉
                                </h4>
                                <p style={{ opacity: 0.8 }}>
                                ...
                                <div style={{
                                    ...
                                    <div style={{ marginBottom: "1rem" }}>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setNovoDesafio(prev => ({ 
                                                ...prev, 
                                        ...
                                        >
                                            <option value="fisico" style={{ 
                                                background: "#1a1a1a",
                                                color: "white",
                                                padding: "0.8rem",
                                                fontSize: "1rem"
                                            }}>Físico</option>
                                            <option value="mental" style={{ 
                                                background: "#1a1a1a",
                                                color: "white",
                                                padding: "0.8rem",
                                                fontSize: "1rem"
                                            }}>Mental</option>
                                            <option value="espiritual" style={{ 
                                                background: "#1a1a1a",
                                                color: "white",
                                                padding: "0.8rem",
                                                fontSize: "1rem"
                                    ...
                                    <div style={{ marginBottom: "1.5rem" }}>
                                        ...
                                        >
                                            <option value="facil" style={{ 
                                                background: "#1a1a1a",
                                                color: "white",
                                                padding: "0.8rem",
                                                fontSize: "1rem"
                                            }}>Fácil (10 XP)</option>
                                            <option value="medio" style={{ 
                                                background: "#1a1a1a",
                                                color: "white",
                                                padding: "0.8rem",
                                                fontSize: "1rem"
                                            }}>Médio (20 XP)</option>
                                            <option value="dificil" style={{ 
                                                background: "#1a1a1a",
                                                color: "white",
                                                padding: "0.8rem",
                                                fontSize: "1rem"
                                            }}>Difícil (30 XP)</option>
                                        </select>
                                </div>
                                    ...
                                    <div style={{ display: "flex", gap: "1rem", justifyContent: "flex-end" }}>
                                        <Button
                                            variant="secondary"
                                            onClick={() => setNovoDesafioModalAberto(false)}
                                    >
                                        Cancelar
                                        </Button>
                                        <Button
                                            ...
                                            disabled={!novoDesafio.titulo.trim()}
                                        >
                                            Criar Desafio
                                        </Button>
                                        </div>
                        ...
                        />
                                ...
                                <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "1rem" }}>
                                    <Button
                                        ...
                                        disabled={!Object.values(feedback).some(v => v.trim())}
                                    >
                                        Enviar Feedback
                                    </Button>
                                </div>
                ...
                return (
                    <div>
                        ...
                        <ul style={{ 
                            ...
                            <li>• <strong>Nível e XP:</strong> Clique na barra de progresso para ver todos os níveis</li>
                            <li>• <strong>Progresso Geral:</strong> Mostra o total de desafios completados</li>
                            <li>• <strong>Áreas:</strong> Acompanhe seu progresso em cada categoria</li>
                        </ul>
                        ...
                        <p>
                            Faltam {levelInfo.xpNeeded - levelInfo.xpCurrent} XP para o nível {levelInfo.level + 1}. 
                ...
                return (
                    <div>
                        ...
                        <ul style={{ 
                            ...
                            <li>• <strong>Criar Desafio:</strong> Use o botão "+" no topo</li>
                            <li>• <strong>Filtrar:</strong> Use as abas para ver por área</li>
                            <li>• <strong>Concluir:</strong> Marque o checkbox ao completar</li>
                        </ul>
                        ...
                        <p>
                            Ciclos de 25 minutos de foco, seguidos por 5 minutos de pausa. 
                ...
                return (
                    <div>
                        ...
                        <ul style={{ 
                            ...
                            <li>• <strong>Gráfico de Áreas:</strong> Compare seu progresso em cada categoria</li>
                            <li>• <strong>Streak Diário:</strong> Acompanhe sua consistência</li>
                            <li>• <strong>Feedback:</strong> Compartilhe sua experiência</li>
                            <li>• <strong>Exportar:</strong> Salve seus dados de progresso</li>
                        </ul>
                        ...
                        <p>
                            Analise seus dados semanalmente para ajustar suas metas e estratégias de desenvolvimento.
                        </p>
                    </div>
                );
                ...
                <ul>
                    ...
                    <li>
                        <button 
                            ...
                            className={activeTab === "desafios" ? "active" : ""}
                        >
                            Desafios
                        </button>
                    </li>
